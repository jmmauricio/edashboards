...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 8 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'S_n_1', 'Omega_b_1', 'H_1', 'T1d0_1', 'T1q0_1', 'X_d_1', 'X_q_1', 'X1d_1', 'X1q_1', 'D_1', 'R_a_1', 'K_delta_1', 'K_sec_1', 'Droop_1', 'T_gov_1_1', 'T_gov_2_1', 'T_gov_3_1', 'K_imw_1', 'omega_ref_1', 'S_n_2', 'Omega_b_2', 'H_2', 'T1d0_2', 'T1q0_2', 'X_d_2', 'X_q_2', 'X1d_2', 'X1q_2', 'D_2', 'R_a_2', 'K_delta_2', 'K_sec_2', 'K_a_2', 'K_ai_2', 'T_r_2', 'V_min_2', 'V_max_2', 'K_aw_2', 'Droop_2', 'T_gov_1_2', 'T_gov_2_2', 'T_gov_3_2', 'K_imw_2', 'omega_ref_2', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 76.92307692307692, -384.6153846153846, -1e-05, 20000.0, 20000.0, 900000000.0, 314.1592653589793, 5.0, 8.0, 0.4, 1.8, 1.7, 0.3, 0.55, 1.0, 0.01, 0.0, 0.0, 0.05, 1.0, 2.0, 10.0, 0.1, 1.0, 90000000000.0, 314.1592653589793, 5.0, 8.0, 0.4, 1.8, 1.7, 0.3, 0.55, 1.0, 0.0025, 0.01, 0.01, 100, 1e-06, 0.02, -5, 5.0, 2.0, 0.05, 1.0, 2.0, 10.0, 0.0, 1.0, 1.0, 0.1, 0.0] 
        self.inputs_ini_list = ['P_1', 'Q_1', 'P_2', 'Q_2', 'v_f_1', 'p_c_1', 'p_r_1', 'v_ref_2', 'v_pss_2', 'p_c_2', 'p_r_2'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 500000000.0, 0.0, 1.0, 0.01, 0.0, 1.0, 0.0, 0.01, 0.0] 
        self.inputs_run_list = ['P_1', 'Q_1', 'P_2', 'Q_2', 'v_f_1', 'p_c_1', 'p_r_1', 'v_ref_2', 'v_pss_2', 'p_c_2', 'p_r_2'] 
        self.inputs_run_values_list = [0.0, 0.0, 500000000.0, 0.0, 1.0, 0.01, 0.0, 1.0, 0.0, 0.01, 0.0] 
        self.outputs_list = ['V_1', 'V_2', 'p_line_1_2', 'q_line_1_2', 'p_line_2_1', 'q_line_2_1', 'p_e_1', 'p_e_2'] 
        self.x_list = ['delta_1', 'omega_1', 'e1q_1', 'e1d_1', 'x_gov_1_1', 'x_gov_2_1', 'xi_imw_1', 'delta_2', 'omega_2', 'e1q_2', 'e1d_2', 'v_c_2', 'xi_v_2', 'x_gov_1_2', 'x_gov_2_2', 'xi_imw_2', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'p_m_ref_1', 'p_m_1', 'i_d_2', 'i_q_2', 'p_g_2', 'q_g_2', 'v_f_2', 'p_m_ref_2', 'p_m_2', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'p_m_ref_1', 'p_m_1', 'i_d_2', 'i_q_2', 'p_g_2', 'q_g_2', 'v_f_2', 'p_m_ref_2', 'p_m_2', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 34, 0, 1, 17, 18, 21, 22, 26, 34, 2, 21, 3, 22, 4, 25, 4, 5, 6, 23, 7, 8, 34, 7, 8, 19, 20, 27, 28, 33, 34, 9, 27, 31, 10, 28, 11, 19, 11, 12, 31, 13, 32, 13, 14, 15, 29, 16, 34, 17, 18, 19, 20, 23, 17, 18, 19, 20, 24, 17, 18, 19, 20, 29, 17, 18, 19, 20, 30, 0, 2, 17, 18, 21, 22, 0, 3, 17, 18, 21, 22, 0, 17, 18, 21, 22, 23, 0, 17, 18, 21, 22, 24, 1, 6, 25, 35, 4, 5, 26, 7, 9, 19, 20, 27, 28, 7, 10, 19, 20, 27, 28, 7, 19, 20, 27, 28, 29, 7, 19, 20, 27, 28, 30, 11, 12, 31, 8, 15, 32, 35, 13, 14, 33, 1, 8, 34, 16, 34, 35]
    sp_jac_ini_ja = [0, 3, 11, 13, 15, 17, 19, 21, 24, 32, 35, 37, 39, 42, 44, 46, 48, 50, 55, 60, 65, 70, 76, 82, 88, 94, 98, 101, 107, 113, 119, 125, 128, 132, 135, 138, 141]
    sp_jac_ini_nia = 36
    sp_jac_ini_nja = 36
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 34, 0, 1, 17, 18, 21, 22, 26, 34, 2, 21, 3, 22, 4, 25, 4, 5, 6, 23, 7, 8, 34, 7, 8, 19, 20, 27, 28, 33, 34, 9, 27, 31, 10, 28, 11, 19, 11, 12, 31, 13, 32, 13, 14, 15, 29, 16, 34, 17, 18, 19, 20, 23, 17, 18, 19, 20, 24, 17, 18, 19, 20, 29, 17, 18, 19, 20, 30, 0, 2, 17, 18, 21, 22, 0, 3, 17, 18, 21, 22, 0, 17, 18, 21, 22, 23, 0, 17, 18, 21, 22, 24, 1, 6, 25, 35, 4, 5, 26, 7, 9, 19, 20, 27, 28, 7, 10, 19, 20, 27, 28, 7, 19, 20, 27, 28, 29, 7, 19, 20, 27, 28, 30, 11, 12, 31, 8, 15, 32, 35, 13, 14, 33, 1, 8, 34, 16, 34, 35]
    sp_jac_run_ja = [0, 3, 11, 13, 15, 17, 19, 21, 24, 32, 35, 37, 39, 42, 44, 46, 48, 50, 55, 60, 65, 70, 76, 82, 88, 94, 98, 101, 107, 113, 119, 125, 128, 132, 135, 138, 141]
    sp_jac_run_nia = 36
    sp_jac_run_nja = 36
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 34, 0, 1, 17, 18, 21, 22, 26, 34, 2, 21, 3, 22, 4, 25, 4, 5, 6, 23, 7, 8, 34, 7, 8, 19, 20, 27, 28, 33, 34, 9, 27, 31, 10, 28, 11, 19, 11, 12, 31, 13, 32, 13, 14, 15, 29, 16, 34, 17, 18, 19, 20, 23, 17, 18, 19, 20, 24, 17, 18, 19, 20, 29, 17, 18, 19, 20, 30, 0, 2, 17, 18, 21, 22, 0, 3, 17, 18, 21, 22, 0, 17, 18, 21, 22, 23, 0, 17, 18, 21, 22, 24, 1, 6, 25, 35, 4, 5, 26, 7, 9, 19, 20, 27, 28, 7, 10, 19, 20, 27, 28, 7, 19, 20, 27, 28, 29, 7, 19, 20, 27, 28, 30, 11, 12, 31, 8, 15, 32, 35, 13, 14, 33, 1, 8, 34, 16, 34, 35]
    sp_jac_trap_ja = [0, 3, 11, 13, 15, 17, 19, 21, 24, 32, 35, 37, 39, 42, 44, 46, 48, 50, 55, 60, 65, 70, 76, 82, 88, 94, 98, 101, 107, 113, 119, 125, 128, 132, 135, 138, 141]
    sp_jac_trap_nia = 36
    sp_jac_trap_nja = 36
